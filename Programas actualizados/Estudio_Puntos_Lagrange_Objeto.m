...
Sat.r = [xs, ys];
Sat.v = [vxs, vys];
Y_0 = [0 -sqrt(G*M_T/r_l)/M_T*M_L,0 0,1 0 ,0 sqrt(G*M_T/r_l),Sat.r(1) Sat.v(1),Sat.r(2) Sat.v(2)];% Vector de condiciones iniciales
